...
static const FText SandboxDocumentation = LOCTEXT(
	...
	"- Add '#include \"Sketch.h\" to any file. Note that function from previous step handles Sketch availability for you.\n"
	"  So you don't need to check if Sketch is actually available under current build configuration.\n"
